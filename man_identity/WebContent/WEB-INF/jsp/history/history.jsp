...
<!-- </ul> -->
<!-- </div> -->
<iframe id="right" onload="javascript:{dyniframesize('right');}" marginwidth=0 marginheight=0 frameborder=0  src="${ctx }/history/showPage" class="c_right1" name="right" ></iframe>
<!-- </div>  -->
<!-- </div> -->
